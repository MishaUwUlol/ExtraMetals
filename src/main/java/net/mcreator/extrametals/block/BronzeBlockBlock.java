...
public class BronzeBlockBlock extends ExtraMetalsModElements.ModElement {
	@ObjectHolder("extra_metals:bronze_block")
	public static final Block block = null;
	public BronzeBlockBlock(ExtraMetalsModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(3f, 3f).setLightLevel(s -> 0).harvestLevel(0)
