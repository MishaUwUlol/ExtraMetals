...
public class ZincIngotItem extends ExtraMetalsModElements.ModElement {
	@ObjectHolder("extra_metals:zinc_ingot")
	public static final Item block = null;
	public ZincIngotItem(ExtraMetalsModElements instance) {
		super(instance, 40);
	}
