...
public class NativeCopperItem extends ExtraMetalsModElements.ModElement {
	@ObjectHolder("extra_metals:native_copper")
	public static final Item block = null;
	public NativeCopperItem(ExtraMetalsModElements instance) {
		super(instance, 3);
	}
