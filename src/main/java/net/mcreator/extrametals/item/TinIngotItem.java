...
public class TinIngotItem extends ExtraMetalsModElements.ModElement {
	@ObjectHolder("extra_metals:tin_ingot")
	public static final Item block = null;
	public TinIngotItem(ExtraMetalsModElements instance) {
		super(instance, 19);
	}
