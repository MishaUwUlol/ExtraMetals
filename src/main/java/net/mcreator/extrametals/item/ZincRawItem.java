...
public class ZincRawItem extends ExtraMetalsModElements.ModElement {
	@ObjectHolder("extra_metals:zinc_raw")
	public static final Item block = null;
	public ZincRawItem(ExtraMetalsModElements instance) {
		super(instance, 39);
	}
